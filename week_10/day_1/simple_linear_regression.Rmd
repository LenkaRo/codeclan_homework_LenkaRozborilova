...
```{r}
# estimated_length = b0 + b1 * actual_length

# b0 = 1.416 fitted model will intercept y axis at 1.416
# b1 = 1.223 slope (gradient) of the model line. With every increase of the actual_length by 1 unit, the estimated_length will increase by 1.223 units
# r^2 = 0.6474772	(coef. of determination) explains how good fit our model is. Not so good.. low amount of explained variation
```
