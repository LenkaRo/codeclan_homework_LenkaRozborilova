...
glmulti_search_all_mains <- glmulti(
  ...
  fitfunction = "glm",               # use lm() as fit function. Can also use glm() for logistic regression.
...
### Conclusion: I split the data set containing information on sales of orange juice into train and test data sets. Using the train data set, I developed 10 best logistic regresion models, containing main effects and one pair wise interation as explanatory variables. I then applied these models onto the test data set and calculated root-mean-square error (RMSE) for each of the models. This model came as the best model over all (lowest RMSE = 2.981748):
